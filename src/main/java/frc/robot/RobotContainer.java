...
public class RobotContainer {
  ...
  public static XboxController pilot = new XboxController(OIConstants.kDriverControllerPort);
  public static XboxController copilot = new XboxController(OIConstants.kCopilotControllerPort);
  ...
  public Command getAutonomousCommand() {
    ...
    Trajectory driveBackwardsUntilLimitTrajectory = TrajectoryGenerator.generateTrajectory(
      ...
      driveBackwardsUntilLimitTrajectoryConfig);
