...
public final class Constants {
  ...
  public static final class ModuleConstants {
    ...
    public static final double kDrivingMotorReduction = (45.0 * 22) / (kDrivingMotorPinionTeeth * 15);  // jerry knows about these Change eventually
  ...
  public static final class LauncherConstants{
    ...
    public static final double kMaxRotationLauncherSpeed=0.75;
    public static final double kMinRotationLauncherSpeed=0.16;
    public static final double kMaxRotationFeedSpeed=0.2;
  }
  ...
  public static final class SweeperConstants{
    public static final int sweeperMotor = 5;
    public static final double kMaxRotationSweeperSpeed=0.8;
  }
}
